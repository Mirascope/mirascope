...
export class MirascopeClient {
    ...
    public get organizationInvitations(): OrganizationInvitationsClient {
        return (this._organizationInvitations ??= new OrganizationInvitationsClient(this._options));
    }

    public get organizationMemberships(): OrganizationMembershipsClient {
        return (this._organizationMemberships ??= new OrganizationMembershipsClient(this._options));
    }
    ...
    public get projectMemberships(): ProjectMembershipsClient {
        return (this._projectMemberships ??= new ProjectMembershipsClient(this._options));
    }
