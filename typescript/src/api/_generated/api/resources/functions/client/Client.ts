...
export class FunctionsClient {
    ...
    private async __list(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/functions");
    }
    ...
    private async __get(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/functions/{id}");
    }
    ...
    private async __delete(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/functions/{id}");
    }
    ...
    public findbyhash(
        ...
        return core.HttpResponsePromise.fromPromise(this.__findbyhash(request, requestOptions));
    }
    ...
    private async __findbyhash(
        ...
        if (_response.ok) {
            return {
                data: serializers.FunctionsFindByHashResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/functions/hash/{hash}");
    }
    ...
    public getbyenv(
        ...
        return core.HttpResponsePromise.fromPromise(this.__getbyenv(request, requestOptions));
    }
    ...
    private async __getbyenv(
        ...
        if (_response.ok) {
            return {
                data: serializers.FunctionsGetByEnvResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    public listbyenv(
        ...
        return core.HttpResponsePromise.fromPromise(this.__listbyenv(request, requestOptions));
    }
    ...
    private async __listbyenv(
        ...
        if (_response.ok) {
            return {
                data: serializers.FunctionsListByEnvResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
