...
describe('Toolkit', () => {
  ...
  it('creates toolkit with tools', () => {
    ...
    expect(toolkit.has('get_weather')).toBe(true);
    expect(toolkit.has('search_web')).toBe(true);
  });
  ...
  it('gets tool by name', () => {
    ...
    expect(toolkit.get('get_weather')).toBe(getWeather);
    expect(toolkit.get('search_web')).toBe(searchWeb);
    expect(toolkit.get('nonexistent')).toBeUndefined();
  });
  ...
  it('checks if tool exists', () => {
    ...
    expect(toolkit.has('get_weather')).toBe(true);
    expect(toolkit.has('nonexistent')).toBe(false);
  });
...
describe('ContextToolkit', () => {
  ...
  it('creates context toolkit with tools', () => {
    ...
    expect(toolkit.tools).toHaveLength(2);
    expect(toolkit.has('search_db')).toBe(true);
    expect(toolkit.has('fetch_url')).toBe(true);
  });
  ...
  it('gets tool by name', () => {
    ...
    expect(toolkit.get('search_db')).toBe(searchDb);
    expect(toolkit.get('nonexistent')).toBeUndefined();
  });
...
describe('createToolkit', () => {
  it('creates toolkit from tools array', () => {
    ...
    expect(toolkit.has('test')).toBe(true);
  });
});
...
describe('ContextToolkit with mixed tools', () => {
  ...
  it('accepts both regular and context tools', () => {
    ...
    expect(toolkit.tools).toHaveLength(2);
    expect(toolkit.has('add_numbers')).toBe(true);
    expect(toolkit.has('multiply_with_context')).toBe(true);
  });
...
describe('normalizeTools', () => {
  ...
  it('wraps array in new Toolkit', () => {
    ...
    expect(result.tools).toHaveLength(1);
    expect(result.has('test_tool')).toBe(true);
  });
});
...
describe('normalizeContextTools', () => {
  ...
  it('wraps array in new ContextToolkit', () => {
    ...
    expect(result.tools).toHaveLength(1);
    expect(result.has('test_context_tool')).toBe(true);
  });
});
