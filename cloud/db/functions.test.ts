    ...
    describe("versioning", () => {
      ...
      it.effect("same hash returns existing function", () =>
        Effect.gen(function* () {
          ...
          // First registration
          const first = yield* db.functions.create({
            userId: owner.id,
            organizationId: org.id,
            projectId: project.id,
            environmentId: environment.id,
          ...
          const second = yield* db.functions.create({
            userId: owner.id,
            organizationId: org.id,
            projectId: project.id,
            environmentId: environment.id,
      ...
      it.effect("same signatureHash gets minor version bump", () =>
        Effect.gen(function* () {
          ...
          // First version
          const v1 = yield* db.functions.create({
            userId: owner.id,
            organizationId: org.id,
            projectId: project.id,
            environmentId: environment.id,
          ...
          const v2 = yield* db.functions.create({
            userId: owner.id,
            organizationId: org.id,
            projectId: project.id,
            environmentId: environment.id,
  ...
  describe("getByHash", () => {
    it.effect("returns function by hash", () =>
      Effect.gen(function* () {
        ...
        const found = yield* db.functions.getByHash({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
  ...
  describe("getById", () => {
    it.effect("returns function by id", () =>
      Effect.gen(function* () {
        ...
        const input = createFunctionInput();
        const created = yield* db.functions.create({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
        ...
        const found = yield* db.functions.getById({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
  ...
  describe("findAll", () => {
    it.effect("returns all functions in environment", () =>
      Effect.gen(function* () {
        ...
        const result = yield* db.functions.findAll({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
  ...
  describe("findById", () => {
    it.effect("returns function by functionId", () =>
      Effect.gen(function* () {
        ...
        const found = yield* db.functions.findById({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
