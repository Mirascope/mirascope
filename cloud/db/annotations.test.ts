  ...
  describe("create", () => {
    it.effect("creates an annotation for a span", () =>
      Effect.gen(function* () {
        ...
        const annotation = yield* db.annotations.create({
          userId: owner.id,
    ...
    it.effect("returns NotFoundError when span does not exist", () =>
      Effect.gen(function* () {
        ...
        const result = yield* db.annotations
          .create({
            userId: owner.id,
            organizationId: org.id,
            projectId: project.id,
  ...
  describe("getById", () => {
    it.effect("returns annotation by ID", () =>
      Effect.gen(function* () {
        ...
        const created = yield* db.annotations.create({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
        ...
        const found = yield* db.annotations.getById({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
  ...
  describe("update", () => {
    it.effect("updates annotation label", () =>
      Effect.gen(function* () {
        ...
        const updated = yield* db.annotations.update({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
  ...
  describe("list", () => {
    it.effect("lists all annotations in environment", () =>
      Effect.gen(function* () {
        ...
        const listResult = yield* db.annotations.list({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
    ...
    it.effect("filters by label", () =>
      Effect.gen(function* () {
        ...
        const positiveResult = yield* db.annotations.list({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
        ...
        const negativeResult = yield* db.annotations.list({
          userId: owner.id,
          organizationId: org.id,
          projectId: project.id,
          environmentId: environment.id,
