...
CREATE TABLE "functions" (
	...
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "functions_hash_environment_id_unique" UNIQUE("hash","environment_id")
);
--> statement-breakpoint
...
CREATE INDEX "annotations_env_created_at_idx" ON "annotations" USING btree ("environment_id","created_at");--> statement-breakpoint
CREATE INDEX "functions_env_name_idx" ON "functions" USING btree ("environment_id","name");--> statement-breakpoint
CREATE INDEX "functions_env_sig_hash_idx" ON "functions" USING btree ("environment_id","signature_hash");