...
ALTER TABLE "spans" ADD CONSTRAINT "spans_trace_db_id_traces_id_fk" FOREIGN KEY ("trace_db_id") REFERENCES "public"."traces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
