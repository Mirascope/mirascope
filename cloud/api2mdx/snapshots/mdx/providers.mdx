...
**Bases:** 
<TypeLink type={{"type_str": "BaseOpenAICompletionsProvider", "description": null, "kind": "simple", "symbol_name": "BaseOpenAICompletionsProvider", "doc_url": "/docs/mirascope/v2/api/providers#base-open-a-i-completions-provider"}} />
