        ...
        <div className="border-secondary border-2">
          <div className="py-6">
            <div className="mx-auto max-w-5xl">
              <h1 className="mb-8 text-xl font-semibold">ContentLayout Test</h1>
              ...
              <div className="bg-muted/50 mb-4 p-4">
                ...
                <p>ContentLayout manages the three-column layout structure:</p>
              ...
              <div className="border-accent bg-accent/5 mb-8 border-l-4 p-4 text-sm font-medium">
                <p>
                  Scroll down to test the sidebar behavior. The sidebars should:
                </p>
                <ul className="mt-2 list-disc pl-5">
              ...
              <div className="text-muted-foreground mt-8 mb-4 text-sm">
                ...
                <p className="mt-1">Green border: ContentLayout.Content</p>
                <p className="mt-1">Blue border: ContentLayout.LeftSidebar</p>
                <p className="mt-1">
                  Purple border: ContentLayout.RightSidebar
                </p>
              </div>
            </div>
          </div>
