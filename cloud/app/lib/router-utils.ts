...
import { getAllDocInfo, type BlogMeta } from "@/app/lib/content/content";
import llmMeta from "@/content/llms/_llms-meta";
import type { LLMContent } from "@/app/lib/content/llm-content";

import { isHiddenRoute } from "@/app/lib/hidden-routes";
...
export function getStaticRoutes(): string[] {
  ...
  const routeTreePath = path.join(getProjectRoot(), "app", "routeTree.gen.ts");
