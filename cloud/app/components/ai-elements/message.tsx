...
export const MessageContent = ({
  ...
  <div
    className={cn(
      "flex w-fit max-w-full min-w-0 flex-col gap-2 overflow-hidden font-sans text-sm",
      "group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:bg-mirple group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:text-white",
