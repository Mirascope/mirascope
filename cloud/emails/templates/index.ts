/**
 * @fileoverview Email template exports.
 *
 * React Email components for transactional emails including welcome emails
 * and reusable UI components (logo, buttons, footer).
 */
