  ...
  Effect.gen(function* () {
    ...
    yield* drizzle
      ...
      .set({
        ...
        status: "provisioning",
        // Mac Mini deployment fields (null for Cloudflare deployments)
        miniId: status.miniId ?? null,
        miniPort: status.miniPort ?? null,
        tunnelHostname: status.tunnelHostname ?? null,
        updatedAt: new Date(),
      })
