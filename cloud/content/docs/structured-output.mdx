...
<Note>
When validation fails, consider retrying with error feedback. See [Reliability](/docs/reliability) for retry patterns.
</Note>
...
- [Streaming](/docs/streaming) — Stream responses with structured output
- [Reliability](/docs/reliability) — Retry on validation errors
- [Tools](/docs/tools) — Combine tools with structured output
