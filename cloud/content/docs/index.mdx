...
See [Models](/docs/models) for parameters, model overrides, and more.
...
See [Prompts](/docs/prompts) for return types, multimodal content, and more.
...
See [Calls](/docs/calls) for runtime overrides, parameters, and more.
...
See [Responses](/docs/responses) for content access, metadata, and more.
...
See [Tools](/docs/tools) for async tools, parallel execution, and more.
...
See [Structured Output](/docs/structured-output) for formatting modes, validation, and more.
...
See [Streaming](/docs/streaming) for stream iterators, accumulated content, and more.
...
See [Async](/docs/async) for parallel calls, async tools, and more.
