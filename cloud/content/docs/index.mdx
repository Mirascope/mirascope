...
<Tab value="uv">
```bash
uv add "mirascope[all]==2.0.0-beta.0"
```
</Tab>
<Tab value="pip">
```bash
pip install "mirascope[all]==2.0.0-beta.0"
```
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Sync">
<CodeExample file="python/examples/intro/decorator/sync.py" />
</Tab>
<Tab value="Stream">
<CodeExample file="python/examples/intro/decorator/stream.py" />
</Tab>
<Tab value="Async">
<CodeExample file="python/examples/intro/decorator/async.py" />
</Tab>
<Tab value="Async Stream">
<CodeExample file="python/examples/intro/decorator/async_stream.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Sync">
<CodeExample file="python/examples/intro/model/sync.py" />
</Tab>
<Tab value="Stream">
<CodeExample file="python/examples/intro/model/stream.py" />
</Tab>
<Tab value="Async">
<CodeExample file="python/examples/intro/model/async.py" />
</Tab>
<Tab value="Async Stream">
<CodeExample file="python/examples/intro/model/async_stream.py" />
</Tab>
</TabbedSection>
...
| `usage` | `Usage | None` | The token usage of this response, if available |
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/parameters/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/parameters/model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/override/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/override/model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/resume/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/resume/model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/tool_call/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/tool_call/model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/format/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/format/model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/register_provider/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/register_provider/model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/local_model/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/local_model/model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/mlx/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/mlx/model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Decorator">
<CodeExample file="python/examples/intro/context/decorator.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/intro/context/model.py" />
</Tab>
</TabbedSection>
