...
In this recipe, we will be using taking our [Web Search Agent Tutorial](/docs/mirascope/guides/agents/web-search-agent) and running evaluations on the LLM call. We will be exploring writing a context relevance test since that is one of the most important aspects of web search.
...
<li><a href="/docs/mirascope/learn/async/">Async</a></li>
<li><a href="/docs/mirascope/learn/evals/">Evals</a></li>
</ul>
</Info>

<Note title="Check out the Web Search Agent Tutorial">
We will be using our `WebAssistantAgent` for our evaluations. For a detailed explanation regarding this code snippet, refer to the [Web Search Agent Tutorial](/docs/mirascope/guides/agents/web-search-agent).
</Note>
