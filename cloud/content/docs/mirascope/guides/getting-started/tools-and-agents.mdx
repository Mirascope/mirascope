---
title: Tools & Agents
description: An introduction to building tools and agents with Mirascope. Learn how to create autonomous systems that can use tools to accomplish tasks.
---
...
- [Tools documentation](/docs/mirascope/learn/tools)
- [Agents documentation](/docs/mirascope/learn/agents)
...
For more information on setting up Mirascope and its dependencies, see the [Mirascope getting started guide](/docs/mirascope/guides/getting-started/quickstart).
...
For more details on implementing and using Tools in Mirascope, see the [Tools documentation](/docs/mirascope/learn/tools).
...
- [Agents](/docs/mirascope/learn/agents)
- [Streams](/docs/mirascope/learn/streams)
- [Chaining](/docs/mirascope/learn/chaining)
