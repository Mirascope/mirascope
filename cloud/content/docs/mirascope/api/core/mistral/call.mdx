...
## <ApiType type="Alias" path="core/mistral/call" symbolName="call" /> call
...
<ParametersTable
  ...
  },
  {
    "name": "output_parser",
    "type_info": {
      "type_str": "Callable[[MistralCallResponse | ResponseModelT], Any]",
      "description": null,
      "kind": "callable",
      "base_type": {
        "type_str": "Callable",
      ...
      "parameters": [
        {
          "type_str": "[MistralCallResponse | ResponseModelT]",
          "description": null,
          "kind": "tuple",
          "base_type": {
            "type_str": "tuple",
