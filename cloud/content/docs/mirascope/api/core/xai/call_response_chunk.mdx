...
**Bases:** 
<TypeLink type={{"type_str": "OpenAICallResponseChunk", "description": null, "kind": "simple", "doc_url": "/docs/mirascope/api/core/openai/call_response_chunk#openaicallresponsechunk"}} />
