...
<Info>
MCP tools are always async. You'll want to read the [Tools](/docs/tools) and [Async](/docs/async) guides first.
</Info>
...
- [Async](/docs/async) — Async patterns
- [Agents](/docs/agents) — Build agents with MCP tools
