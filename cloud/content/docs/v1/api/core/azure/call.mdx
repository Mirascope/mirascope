...
## <ApiType type="Alias" path="core/azure/call" symbolName="call" /> call
...
<ParametersTable
  ...
  },
  {
    "name": "output_parser",
    "type_info": {
      "type_str": "Callable[[AzureCallResponse | ResponseModelT], Any]",
      "description": null,
      "kind": "callable",
      "base_type": {
        "type_str": "Callable",
      ...
      "parameters": [
        {
          "type_str": "[AzureCallResponse | ResponseModelT]",
          "description": null,
          "kind": "tuple",
          "base_type": {
            "type_str": "tuple",
