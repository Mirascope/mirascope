...
## <ApiType type="Alias" path="core/google/call" symbolName="call" /> call
...
<ParametersTable
  ...
  },
  {
    "name": "output_parser",
    "type_info": {
      "type_str": "Callable[[GoogleCallResponse | ResponseModelT], Any]",
      "description": null,
      "kind": "callable",
      "base_type": {
        "type_str": "Callable",
      ...
      "parameters": [
        {
          "type_str": "[GoogleCallResponse | ResponseModelT]",
          "description": null,
          "kind": "tuple",
          "base_type": {
            "type_str": "tuple",
