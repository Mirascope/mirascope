...
description: Build an agent system that researches topics and writes blog posts. This guide demonstrates how to combine research and writing capabilities in an agent executor framework.
---
...
<li><a href="/docs/v1/learn/streams/">Streams</a></li>
<li><a href="/docs/v1/learn/tools/">Tools</a></li>
<li><a href="/docs/v1/learn/response_models/">Response Model</a></li>
<li><a href="/docs/v1/learn/output_parsers/">Output Parser</a></li>
<li><a href="/docs/v1/learn/retries/">Retries</a></li>
</ul>
</Info>
...
flowchart TD
    ...
    %% Define empty classes (styling will be applied via CSS)
    classDef primary fill:#6366f1
    classDef secondary fill:#00b49c
    classDef tertiary fill:#db6656
    
    %% Assign classes to nodes
    class AE,RA primary
    class R,WID,WS,PW secondary
    class OAPI tertiary
```
