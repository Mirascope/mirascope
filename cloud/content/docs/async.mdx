...
Tools from [MCP](/docs/mcp) servers are always async, so you'll need to use async when working with MCP.
</Note>
...
- Interacting with [MCP](/docs/mcp) servers
...
- [Tools](/docs/tools) — Learn more about tool calling
- [Agents](/docs/agents) — Build agents with async patterns
