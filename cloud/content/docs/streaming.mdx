...
See [Async](/docs/async) for more on async patterns.
...
For retry strategies and fallback patterns, see [Reliability](/docs/reliability).
...
- [Async](/docs/async) — Async patterns including async streaming
- [Tools](/docs/tools) — Tool calling in depth
- [Structured Output](/docs/structured-output) — Structured output parsing
- [Agents](/docs/agents) — Build agents with streaming responses
