...
<Note>
Parallel chains require async functions. See [Async](/docs/async) for more on async patterns.
</Note>
...
- [Async](/docs/async) — Concurrent execution patterns
- [Agents](/docs/agents) — Autonomous systems that chain tools and calls
