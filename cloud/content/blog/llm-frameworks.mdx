...
Mirascope’s [call decorator](/docs/mirascope/learn/calls/) (e.g., `@openai.call()`) converts regular Python functions into [prompts](/blog/advanced-prompt-engineering/) by turning the function signature and return statement into an API request.
...
For examples of complex, real-world agents, we recommend checking out our [agent tutorials](/docs/mirascope/guides/agents/web-search-agent/). 
...
Want to learn more? You can find more Mirascope code samples both on our [documentation site](/docs/mirascope) and on our [GitHub repository](https://github.com/mirascope/mirascope).  
