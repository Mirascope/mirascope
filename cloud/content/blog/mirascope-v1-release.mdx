...
Take a look at our [migration guide](/docs/mirascope/getting-started/migration/) and [learn documentation](/docs/mirascope/learn) for a deeper dive that covers everything in detail.
...
1. Check out our [Quick Start Guide](/docs/mirascope/guides/getting-started/quickstart) to set up Mirascope in minutes.
2. Explore our [Usage Documentation](/docs/mirascope/learn) for in-depth guides and examples.
