...
The example below is from the Mirascope docs about [evaluations](/docs/mirascope/learn/evals/#panel-of-judges).
...
We also support a range of [popular providers](/docs/mirascope/), like OpenAI, Mistral, Gemini, Groq, and more.
...
Want to learn more about how Mirascope can help you simplify and scale the evaluation process? You can find Mirascope code samples both in our [documentation](/docs/mirascope) and on [GitHub](https://github.com/mirascope/mirascope/).
