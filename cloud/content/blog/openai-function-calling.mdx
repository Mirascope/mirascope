...
As long as your functions are documented with docstrings, you can work with [other providers](/docs/mirascope/learn/calls) without needing to make many code changes, as Mirascope reformats the code in the background.
...
Want to learn more? You can find more Mirascope code samples, docs, and a tutorial on both our [docs](/docs/mirascope) and on [GitHub](https://github.com/mirascope/mirascope/).
