...
[Lilypad](/docs/lilypad) allows you to automatically version, trace, and manage prompts (functions) by simply adding the Python decorator `@lilypad.trace` to your LLM functions.  
...
![Lilypad Prompt Editor Screenshot](/assets/blog/prompt-evaluation/lilypad_editor_screenshot.webp)
...
[Lilypad](/docs/lilypad) automatically versions and traces all prompt changes to support experiments and collaboration, allowing you to identify what worked and what didn’t. This includes:
...
You can find more Mirascope [evaluation tutorials](/docs/mirascope/guides/evals/evaluating-web-search-agent/) both on our [documentation site](/docs/mirascope) and our [GitHub page](https://github.com/mirascope/mirascope).
