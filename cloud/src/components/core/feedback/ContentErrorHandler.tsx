...
const ContentErrorHandler: React.FC<ContentErrorHandlerProps> = ({
  ...
  const contentTypeConfig = {
    ...
    dev: {
      title: isNotFound ? "Page Not Found" : "Error Loading Page",
      notFoundMessage:
        "The development page you're looking for doesn't exist or has been moved.",
      backTo: "/dev",
      backLabel: "Back to Dev Tools",
    },
    "llm-docs": {
      title: isNotFound
        ? "LLM Document Not Found"
        : "Error Loading LLM Document",
      notFoundMessage:
        "The LLM document you're looking for doesn't exist or has been moved.",
      backTo: "/docs",
      backLabel: "Back to Documentation",
    },
  };
