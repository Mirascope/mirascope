...
// Group redirects map - lazily populated to avoid circular dependency during SSR
let groupRedirects: Record<string, string> | null = null;

// Build the group redirects map from docs metadata (lazy initialization)
function getGroupRedirects(): Record<string, string> {
  if (groupRedirects !== null) {
