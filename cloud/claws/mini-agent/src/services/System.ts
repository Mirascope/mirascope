/**
 * System stats service — CPU, memory, disk monitoring.
 */
...
export interface SystemService {
  readonly getStats: () => Effect.Effect<SystemStats>;
}

export class System extends Context.Tag("MiniAgent/System")<
  System,
  SystemService
>() {}

export const SystemLive = Layer.effect(
  System,
  Effect.gen(function* () {
