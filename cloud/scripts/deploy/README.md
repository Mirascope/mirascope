...
Cloud Worker secrets are uploaded once and persist across deploys. The dispatch worker secrets (CLOUDFLARE_ACCOUNT_ID, SITE_URL) are set idempotently on every run.
