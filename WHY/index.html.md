...
!!! mira "Mirascope"
    ...
    === "OpenAI"
        ...
        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/openai/shorthand.py

        ```
    === "Anthropic"

        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/anthropic/shorthand.py

        ```
    === "Mistral"

        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/mistral/shorthand.py

        ```
    === "Google"

        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/google/shorthand.py

        ```
    === "Groq"

        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/groq/shorthand.py

        ```
    === "Cohere"

        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/cohere/shorthand.py

        ```
    === "LiteLLM"

        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/litellm/shorthand.py

        ```
    === "Azure AI"

        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/azure/shorthand.py

        ```
    === "Bedrock"

        ```python hl_lines="12 19"
            # Code file not found: /home/runner/work/mirascope/mirascope/examples/learn/response_models/basic_usage/bedrock/shorthand.py
