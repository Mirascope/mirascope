...
async def test_tool_sync_or_async_must_match_prompt():
    ...
    llm.call(provider="openai:completions", model_id="openai/gpt-5-mini")(prompt)
    llm.call(provider="openai:completions", model_id="openai/gpt-5-mini", tools=[tool])(
        prompt
    )

    # Error: Async tool with sync prompt
    llm.call(
        provider="openai:completions", model_id="openai/gpt-5-mini", tools=[async_tool]
    )(
    ...
    llm.call(provider="openai:completions", model_id="openai/gpt-5-mini")(async_prompt)
    llm.call(
        provider="openai:completions", model_id="openai/gpt-5-mini", tools=[async_tool]
    )(async_prompt)
