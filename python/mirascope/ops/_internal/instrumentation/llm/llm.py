...
def _wrap_model_stream_async() -> None:
...
def _unwrap_model_stream_async() -> None:
...
def _wrap_model_resume_async() -> None:
...
def _unwrap_model_resume_async() -> None:
...
def _wrap_model_context_resume() -> None:
...
def _unwrap_model_context_resume() -> None:
...
def _wrap_model_context_resume_async() -> None:
...
def _unwrap_model_context_resume_async() -> None:
...
def _wrap_model_resume_stream() -> None:
...
def _unwrap_model_resume_stream() -> None:
...
def _wrap_model_resume_stream_async() -> None:
...
def _unwrap_model_resume_stream_async() -> None:
...
def _wrap_model_context_resume_stream() -> None:
...
def _unwrap_model_context_resume_stream() -> None:
...
def _wrap_model_context_resume_stream_async() -> None:
...
def _unwrap_model_context_resume_stream_async() -> None:
...
def instrument_llm() -> None:
    ...
    _wrap_model_stream()
    _wrap_model_stream_async()
    _wrap_model_context_stream()
    _wrap_model_context_stream_async()

    # Resume methods
    _wrap_model_resume()
    _wrap_model_resume_async()
    _wrap_model_context_resume()
    _wrap_model_context_resume_async()
    _wrap_model_resume_stream()
    _wrap_model_resume_stream_async()
...
def uninstrument_llm() -> None:
    ...
    _unwrap_model_stream_async()
    _unwrap_model_context_stream()
    _unwrap_model_context_stream_async()

    # Resume methods
    _unwrap_model_resume()
    _unwrap_model_resume_async()
    _unwrap_model_context_resume()
    _unwrap_model_context_resume_async()
    _unwrap_model_resume_stream()
