...
from ...anthropic._utils import beta_decode
...
class AzureAnthropicBetaProvider(BaseProvider[AnthropicFoundry]):
    ...
    def _call(
        ...
        **params: Unpack[Params],
        ...
        """Generate an `llm.Response` using the Azure Anthropic beta API."""
        input_messages, resolved_format, kwargs = _utils.beta_encode_request(
            model_id=model_id,
            messages=messages,
            tools=tools,
            format=format,
        ...
        assistant_message, finish_reason, usage = _utils.beta_decode_response(
            beta_response,
            model_id,
    ...
    def _context_call(
        ...
        **params: Unpack[Params],
        ...
        """Generate an `llm.ContextResponse` using the Azure Anthropic beta API."""
        input_messages, resolved_format, kwargs = _utils.beta_encode_request(
            model_id=model_id,
            messages=messages,
            tools=tools,
    ...
    async def _call_async(
        ...
        **params: Unpack[Params],
        ...
        """Generate an `llm.AsyncResponse` using the Azure Anthropic beta API."""
        input_messages, resolved_format, kwargs = _utils.beta_encode_request(
            model_id=model_id,
            messages=messages,
            tools=tools,
    ...
    async def _context_call_async(
        ...
        **params: Unpack[Params],
        ...
        """Generate an `llm.AsyncContextResponse` using the Azure Anthropic beta API."""
        input_messages, resolved_format, kwargs = _utils.beta_encode_request(
            model_id=model_id,
            messages=messages,
            tools=tools,
    ...
    def _stream(
        ...
        **params: Unpack[Params],
        ...
        """Generate an `llm.StreamResponse` using the Azure Anthropic beta API."""
        input_messages, resolved_format, kwargs = _utils.beta_encode_request(
            model_id=model_id,
            messages=messages,
            tools=tools,
    ...
    def _context_stream(
        ...
        **params: Unpack[Params],
        ...
        """Generate an `llm.ContextStreamResponse` using the Azure beta API."""
        input_messages, resolved_format, kwargs = _utils.beta_encode_request(
            model_id=model_id,
            messages=messages,
            tools=tools,
    ...
    async def _stream_async(
        ...
        **params: Unpack[Params],
        ...
        """Generate an `llm.AsyncStreamResponse` using the Azure beta API."""
        input_messages, resolved_format, kwargs = _utils.beta_encode_request(
            model_id=model_id,
            messages=messages,
            tools=tools,
    ...
    async def _context_stream_async(
        ...
        **params: Unpack[Params],
        ...
        """Generate an `llm.AsyncContextStreamResponse` using the Azure beta API."""
        input_messages, resolved_format, kwargs = _utils.beta_encode_request(
            model_id=model_id,
            messages=messages,
            tools=tools,
