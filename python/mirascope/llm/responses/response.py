...
@dataclass
class BR(Generic[FormatT]):
    """Base class underpinning Response, StreamResponse, and AsyncStreamResponse."""
    ...
    """The message history, including all messages that were an input to this response.
    
    Does not include the output message included in the response, as in the case of
    a StreamingResponse it may not be fully reconstructed."""
