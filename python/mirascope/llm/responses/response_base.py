...
class ResponseBase(ABC, Generic[ToolkitT, FormatT]):
    ...
    @overload
    def format(self: "ResponseBase[ToolkitT, None]", partial: Literal[True]) -> None:
    ...
    @overload
    def format(
        self: "ResponseBase[ToolkitT, FormatT]", partial: Literal[True]
    ) -> Partial[FormatT]:
        """Format the response into a `Partial[BaseModel]` (with optional fields).
    ...
    @overload
    def format(
        self: "ResponseBase[ToolkitT, None]", partial: Literal[False] = False
    ) -> None:
    ...
    @overload
    def format(
        self: "ResponseBase[ToolkitT, FormatT]", partial: Literal[False] = False
    ) -> FormatT:
