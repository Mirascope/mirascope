...
OpenAIResponsesClientT = TypeVar("OpenAIResponsesClientT", bound=OpenAICompatibleClient)
AsyncOpenAIResponsesClientT = TypeVar(
    "AsyncOpenAIResponsesClientT", bound=AsyncOpenAICompatibleClient
)
...
class BaseOpenAIResponsesClient(
    BaseClient[
        ...
        OpenAIResponsesClientT,
        AsyncOpenAIResponsesClientT,
        ClientT,
    ],
):
    ...
    Type parameters:
        OpenAIResponsesClientT: The sync provider client type (OpenAI or AzureOpenAI).
        AsyncOpenAIResponsesClientT: The async provider client type (AsyncOpenAI or AsyncAzureOpenAI).
