...
from ...openai.completions.base_openai_completions_client import (
...
class AzureOpenAICompletionsClient(
    BaseOpenAICompletionsClient[OpenAI, AsyncOpenAI, "AzureOpenAICompletionsClient"]
):
    """Azure OpenAI Completions client using the v1 GA API.
