...
class RawFunctionsClient:
    ...
    def getbyhash(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organizations/{jsonable_encoder(organization_id)}/projects/{jsonable_encoder(project_id)}/environments/{jsonable_encoder(environment_id)}/functions/by-hash/{jsonable_encoder(hash)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"organizations/{jsonable_encoder(organization_id)}/projects/{jsonable_encoder(project_id)}/environments/{jsonable_encoder(environment_id)}/functions/{jsonable_encoder(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
