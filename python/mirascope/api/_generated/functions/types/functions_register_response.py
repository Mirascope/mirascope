...
class FunctionsRegisterResponse(UniversalBaseModel):
    id: str
    hash: str
    ...
    code: str
    signature: str
    dependencies: typing.Optional[typing.Dict[str, typing.Optional[FunctionsRegisterResponseDependenciesValue]]] = None
    ...
    is_new: typing_extensions.Annotated[bool, FieldMetadata(alias="isNew")]
