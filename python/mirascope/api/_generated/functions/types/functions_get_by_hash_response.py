...
class FunctionsGetByHashResponse(UniversalBaseModel):
    id: str
    hash: str
    ...
    code: str
    signature: str
    dependencies: typing.Optional[typing.Dict[str, typing.Optional[FunctionsGetByHashResponseDependenciesValue]]] = None
