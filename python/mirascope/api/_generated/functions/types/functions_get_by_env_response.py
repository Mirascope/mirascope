...
from .functions_get_by_env_response_dependencies_value import FunctionsGetByEnvResponseDependenciesValue


class FunctionsGetByEnvResponse(UniversalBaseModel):
    id: str
    hash: str
    ...
    signature: str
    language: str
    dependencies: typing.Optional[typing.Dict[str, typing.Optional[FunctionsGetByEnvResponseDependenciesValue]]] = None
