...
class TracesCreateRequestResourceSpansItemResourceAttributesItemValue(UniversalBaseModel):
    ...
    int_value: typing_extensions.Annotated[
        typing.Optional[TracesCreateRequestResourceSpansItemResourceAttributesItemValueIntValue],
    ...
    array_value: typing_extensions.Annotated[
        typing.Optional[TracesCreateRequestResourceSpansItemResourceAttributesItemValueArrayValue],
        FieldMetadata(alias="arrayValue"),
    ] = None
    kvlist_value: typing_extensions.Annotated[
        typing.Optional[TracesCreateRequestResourceSpansItemResourceAttributesItemValueKvlistValue],
