...
class TracesCreateOtelRequestResourceSpansItemScopeSpansItemSpansItemAttributesItemValue(UniversalBaseModel):
    ...
    int_value: typing_extensions.Annotated[
        typing.Optional[TracesCreateOtelRequestResourceSpansItemScopeSpansItemSpansItemAttributesItemValueIntValue],
    ...
    array_value: typing_extensions.Annotated[
        typing.Optional[TracesCreateOtelRequestResourceSpansItemScopeSpansItemSpansItemAttributesItemValueArrayValue],
        FieldMetadata(alias="arrayValue"),
    ] = None
    kvlist_value: typing_extensions.Annotated[
        typing.Optional[TracesCreateOtelRequestResourceSpansItemScopeSpansItemSpansItemAttributesItemValueKvlistValue],
