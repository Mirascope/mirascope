...
class RawSdkTracesClient:
    ...
    ) -> HttpResponse[SdkTracesCreateResponse]:
        """
        Parameters
        ----------
        resource_spans : typing.Sequence[SdkTracesCreateRequestResourceSpansItem]
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "resourceSpans": convert_and_respect_annotation_metadata(
                    ...
                    annotation=typing.Sequence[SdkTracesCreateRequestResourceSpansItem],
                    direction="write",
                ),
            },
            headers={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=SdkTracesCreateResponse,  # type: ignore
...
class AsyncRawSdkTracesClient:
    ...
    async def sdk_traces_create(
        ...
        *,
        resource_spans: typing.Sequence[SdkTracesCreateRequestResourceSpansItem],
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[SdkTracesCreateResponse]:
        """
        Parameters
        ----------
        resource_spans : typing.Sequence[SdkTracesCreateRequestResourceSpansItem]
