...
sync_snapshot = snapshot(
    {
        "response": {
            ...
            "usage": {
                ...
                "raw": "BetaUsage(cache_creation=BetaCacheCreation(ephemeral_1h_input_tokens=0, ephemeral_5m_input_tokens=0), cache_creation_input_tokens=0, cache_read_input_tokens=0, input_tokens=226, output_tokens=18, server_tool_use=None, service_tier='standard')",
                "total_tokens": 244,
            },
            "messages": [
                SystemMessage(
