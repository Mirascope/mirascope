            ...
            "messages": [
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "id": "toolu_vrtx_017BwgnyvoAedtQTx8pVcYoX",
                                "input": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "id": "toolu_vrtx_01Xce4u8fXFBdWAevQd4DXZs",
                                "input": {
                                    "title": "THE NAME OF THE WIND",
                                    "author": {
                                        "first_name": "Patrick",
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "type": "tool_use",
                                "id": "toolu_vrtx_01JqeU1bwCiTH3gNovHLvh1M",
                                "name": "__mirascope_formatted_output_tool__",
                                "input": {
                                    "title": "THE NAME OF THE WIND",
                                    "author": {
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "type": "tool_use",
                                "id": "toolu_vrtx_016MXbiNdDZ5bnsnJjXSn1TN",
                                "name": "__mirascope_formatted_output_tool__",
                                "input": {
                                    "title": "THE NAME OF THE WIND",
                                    "author": {
