...
sync_snapshot = snapshot(
    {
        "response": {
            ...
            "usage": {
                ...
                "raw": "ResponseUsage(input_tokens=170, input_tokens_details=InputTokensDetails(cached_tokens=0), output_tokens=30, output_tokens_details=OutputTokensDetails(reasoning_tokens=0), total_tokens=200)",
                "total_tokens": 200,
            },
            "messages": [
                SystemMessage(
