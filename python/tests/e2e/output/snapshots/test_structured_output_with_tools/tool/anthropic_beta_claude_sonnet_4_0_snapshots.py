        ...
        "response": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        ToolCall(
                            id="toolu_0143DaRkokS1TS5cM8u1sdhd",
                            name="get_book_info",
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "id": "toolu_01RjryKP5vZLXPFnMm5TK8mi",
                                "input": {
        ...
        "response": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        ToolCall(
                            id="toolu_01K3fVGWKqPJCA6PbJSmRpg6",
                            name="get_book_info",
                            args='{"isbn": "0-7653-1178-X"}',
                        )
                    ],
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "id": "toolu_01JePqgQCpe2vSupW8Bgq6Uw",
                                "input": {
                                    "title": "Mistborn: The Final Empire",
                                    "author": "Brandon Sanderson",
                                    "pages": 544,
        ...
        "response": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        ToolCall(
                            id="toolu_01G1V5xzPYXZ2XTDfpbZfo5n",
                            name="get_book_info",
                            args='{"isbn": "0-7653-1178-X"}',
                        )
                    ],
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "type": "tool_use",
                                "id": "toolu_015m8gkX8cvCtpG2mxkbvPFk",
                                "name": "__mirascope_formatted_output_tool__",
                                "input": {
                                    "title": "Mistborn: The Final Empire",
                                    "author": "Brandon Sanderson",
        ...
        "response": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        ToolCall(
                            id="toolu_018d6yW6nC7oKfywmDGxK4oD",
                            name="get_book_info",
                            args='{"isbn": "0-7653-1178-X"}',
                        )
                    ],
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "type": "tool_use",
                                "id": "toolu_01FKLDpVAhYpwKXtXZBJaJZn",
                                "name": "__mirascope_formatted_output_tool__",
                                "input": {
                                    "title": "Mistborn: The Final Empire",
                                    "author": "Brandon Sanderson",
