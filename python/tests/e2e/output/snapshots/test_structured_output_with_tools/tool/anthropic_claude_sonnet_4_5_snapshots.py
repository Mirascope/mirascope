        ...
        "response": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        ToolCall(
                            id="toolu_01VhZ63mLRSpFrXqK9L8boHF",
                            name="get_book_info",
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "id": "toolu_01FS3cHW2jVMgVtbGAD1AfsX",
                                "input": {
        ...
        "response": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        ToolCall(
                            id="toolu_01VYLafLCYQnQipvr66bYVhN",
                            name="get_book_info",
                            args='{"isbn": "0-7653-1178-X"}',
                        )
                    ],
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "id": "toolu_01VmDqWL8HWP5c2Gd5MWdGki",
                                "input": {
                                    "title": "Mistborn: The Final Empire",
                                    "author": "Brandon Sanderson",
                                    "pages": 544,
        ...
        "response": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        ToolCall(
                            id="toolu_01BixF8qKm6v9Qn8wMBXQB2R",
                            name="get_book_info",
                            args='{"isbn": "0-7653-1178-X"}',
                        )
                    ],
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "type": "tool_use",
                                "id": "toolu_01KaHRLm1Ds7frV9VWqK1rxx",
                                "name": "__mirascope_formatted_output_tool__",
                                "input": {
                                    "title": "Mistborn: The Final Empire",
                                    "author": "Brandon Sanderson",
        ...
        "response": {
            ...
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        ToolCall(
                            id="toolu_014UbRFFWDoAC59gwnneFCMd",
                            name="get_book_info",
                            args='{"isbn": "0-7653-1178-X"}',
                        )
                    ],
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "content": [
                            {
                                "type": "tool_use",
                                "id": "toolu_01DnnBCmeqozgLRauERB8h9Q",
                                "name": "__mirascope_formatted_output_tool__",
                                "input": {
                                    "title": "Mistborn: The Final Empire",
                                    "author": "Brandon Sanderson",
