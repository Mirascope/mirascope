...
test_snapshot = snapshot(
    {
        "response": {
            ...
            "usage": {
                ...
                "raw": "CompletionUsage(completion_tokens=685, prompt_tokens=216, total_tokens=901, completion_tokens_details=CompletionTokensDetails(accepted_prediction_tokens=0, audio_tokens=0, reasoning_tokens=640, rejected_prediction_tokens=0), prompt_tokens_details=PromptTokensDetails(audio_tokens=0, cached_tokens=0))",
                "total_tokens": 901,
            },
            "messages": [
                SystemMessage(
...
"""
                ...
                AssistantMessage(
                    ...
                    raw_message={
                        ...
                        "tool_calls": [
                            {
                                "id": "call_77g4VZMKk9XtZBKw6PW460qv",
                                "function": {
