...
test_snapshot = snapshot(
    {
        "response": {
            ...
            "usage": {
                ...
                "reasoning_tokens": 0,
                "raw": "ResponseUsage(input_tokens=122, input_tokens_details=InputTokensDetails(cached_tokens=0), output_tokens=21, output_tokens_details=OutputTokensDetails(reasoning_tokens=0), total_tokens=143)",
                "total_tokens": 143,
            },
            "messages": [
                SystemMessage(
