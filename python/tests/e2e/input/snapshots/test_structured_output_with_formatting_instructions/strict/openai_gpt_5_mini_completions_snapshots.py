...
test_snapshot = snapshot(
    {
        "response": {
            ...
            "usage": {
                ...
                "raw": "CompletionUsage(completion_tokens=288, prompt_tokens=123, total_tokens=411, completion_tokens_details=CompletionTokensDetails(accepted_prediction_tokens=0, audio_tokens=0, reasoning_tokens=256, rejected_prediction_tokens=0), prompt_tokens_details=PromptTokensDetails(audio_tokens=0, cached_tokens=0))",
                "total_tokens": 411,
            },
            "messages": [
                SystemMessage(
