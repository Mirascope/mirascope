...
test_snapshot = snapshot(
    {
        "response": {
            ...
            "usage": {
                ...
                "reasoning_tokens": 0,
                "raw": "Usage(cache_creation=CacheCreation(ephemeral_1h_input_tokens=0, ephemeral_5m_input_tokens=0), cache_creation_input_tokens=0, cache_read_input_tokens=0, input_tokens=67, output_tokens=43, server_tool_use=None, service_tier='standard')",
                "total_tokens": 110,
            },
            "messages": [
                SystemMessage(
