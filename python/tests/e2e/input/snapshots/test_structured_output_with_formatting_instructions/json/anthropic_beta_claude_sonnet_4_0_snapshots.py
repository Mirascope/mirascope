...
test_snapshot = snapshot(
    {
        "response": {
            ...
            "usage": {
                ...
                "reasoning_tokens": 0,
                "raw": "BetaUsage(cache_creation=BetaCacheCreation(ephemeral_1h_input_tokens=0, ephemeral_5m_input_tokens=0), cache_creation_input_tokens=0, cache_read_input_tokens=0, input_tokens=67, output_tokens=38, server_tool_use=None, service_tier='standard')",
                "total_tokens": 105,
            },
            "messages": [
                SystemMessage(
