...
test_snapshot = snapshot(
    {
        ...
        "usage2": {
            ...
            "cache_write_tokens": 0,
            "reasoning_tokens": 0,
            "raw": "BetaUsage(cache_creation=BetaCacheCreation(ephemeral_1h_input_tokens=0, ephemeral_5m_input_tokens=0), cache_creation_input_tokens=0, cache_read_input_tokens=4602, input_tokens=151, output_tokens=38, server_tool_use=None, service_tier='standard')",
            "total_tokens": 4791,
        },
    }
)
