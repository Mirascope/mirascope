...
test_snapshot = snapshot(
    {
        "response": {
            ...
            "usage": {
                ...
                "raw": """\
cache_tokens_details=None cached_content_token_count=None candidates_token_count=19 candidates_tokens_details=None prompt_token_count=266 prompt_tokens_details=[ModalityTokenCount(
  modality=<MediaModality.TEXT: 'TEXT'>,
  token_count=8
), ModalityTokenCount(
  modality=<MediaModality.IMAGE: 'IMAGE'>,
  token_count=258
)] thoughts_token_count=679 tool_use_prompt_token_count=None tool_use_prompt_tokens_details=None total_token_count=964 traffic_type=None\
""",
                "total_tokens": 964,
            },
            "messages": [
                ...
                AssistantMessage(
                    content=[
                        Text(
                            text='The image displays the red, diagonally oriented text "just an Example" on a white background.'
                        )
                    ],
                    provider_id="google",
                    model_id="google/gemini-2.5-flash",
