    ...
    assert span_data == snapshot(
        {
            ...
            "attributes": {
                ...
                "mirascope.messages": '[{"role":"user","content":[{"type":"text","text":"Recommend a scifi book."}],"name":null}]',
    ...
    assert span_data == snapshot(
        {
            ...
            "attributes": {
                ...
                "mirascope.messages": '[{"role":"user","content":[{"type":"text","text":"As a librarian, Recommend a adventure book."}],"name":null}]',
                "mirascope.response.content": "[]",
                "mirascope.trace.output": "",
            },
            "status": {"status_code": "UNSET", "description": None},
    ...
    assert span_data == snapshot(
        {
            ...
            "attributes": {
                ...
                "mirascope.messages": '[{"role":"user","content":[{"type":"text","text":"As a librarian, Recommend a historical book."}],"name":null}]',
    ...
    assert span_data == snapshot(
        {
            ...
            "attributes": {
                ...
                "mirascope.messages": '[{"role":"user","content":[{"type":"text","text":"As a librarian, Recommend a thriller book."}],"name":null}]',
    ...
    assert span_data == snapshot(
        {
            ...
            "attributes": {
                ...
                "mirascope.messages": '[{"role":"user","content":[{"type":"text","text":"As a librarian, Recommend a science fiction book."}],"name":null}]',
    ...
    assert span_data == snapshot(
        {
            ...
            "attributes": {
                ...
                "mirascope.messages": '[{"role":"user","content":[{"type":"text","text":"As a librarian, Recommend a dystopian book."}],"name":null}]',
