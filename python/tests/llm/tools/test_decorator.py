...
class TestContextTool:
    ...
    def test_untyped_parameter(self) -> None:
        ...
        @llm.tool
        def non_context_tool(ctx) -> str:  # pyright: ignore[reportUnknownParameterType] # noqa: ANN001
            return f"{ctx}"
    ...
    def test_async_untyped_parameter(self) -> None:
        ...
        @llm.tool
        async def non_context_tool(ctx) -> str:  # pyright: ignore[reportUnknownParameterType] # noqa: ANN001
            return f"{ctx}"
