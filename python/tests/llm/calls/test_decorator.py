...
class TestContextCall:
    ...
    def test_missing_type_annotation(self) -> None:
        ...
        @llm.call(provider="openai:completions", model_id="gpt-4o-mini")
        def missing_annotation_prompt(ctx) -> str:  # pyright: ignore[reportMissingParameterType, reportUnknownParameterType] # noqa: ANN001
            return "hi"
    ...
    def test_async_missing_type_annotation(self) -> None:
        ...
        @llm.call(provider="openai:completions", model_id="gpt-4o-mini")
        async def missing_annotation_prompt(ctx) -> str:  # pyright: ignore[reportMissingParameterType, reportUnknownParameterType] # noqa: ANN001
            return "hi"
