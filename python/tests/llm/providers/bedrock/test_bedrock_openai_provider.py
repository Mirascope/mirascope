...
from mirascope.llm.providers.bedrock._utils import default_openai_scopes
...
def test_default_openai_scopes() -> None:
    """Test default_openai_scopes returns OpenAI prefix."""
    scopes = default_openai_scopes()
    assert "bedrock/openai." in scopes
