...
![Mirascope Cloud Landing Page](/assets/blog/llm-monitoring-tools/lilypad-landing-page.webp)
...
![Mirascope Cloud Trace](/assets/blog/llm-monitoring-tools/lilypad-trace.webp)
...
![Mirascope Cloud Click Compare](/assets/blog/llm-monitoring-tools/lilypad-click-compare.webp)

You can select another version and view the differences side-by-side:

![Mirascope Cloud Compare Versions](/assets/blog/llm-monitoring-tools/lilypad-compare-versions.webp)
...
![Mirascope Cloud Annotation Queue](/assets/blog/llm-monitoring-tools/lilypad-annotation-queue.webp)
...
![Mirascope Cloud Annotations](/assets/blog/llm-monitoring-tools/lilypad-annotations.webp)
