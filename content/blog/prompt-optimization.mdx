...
![Mirascope Cloud Nested Traces](/assets/blog/prompt-optimization/lilypad-nested-traces.webp)
...
![Lilypad Answer Question v7 Trace](/assets/blog/_shared/lilypad-trace.webp)

You can also compare different versions side by side, showing all relevant metrics:

![Lilypad Compare Answer Question Versions](/assets/blog/_shared/lilypad-compare-versions.webp)
