...
![Lilypad Landing Page](/assets/blog/_shared/lilypad-homepage.webp)
...
![Lilypad Trace View](/assets/blog/_shared/lilypad-trace.webp)
...
![Lilypad Click Compare](/assets/blog/_shared/lilypad-click-compare.webp)

Clicking this displays a second dropdown menu, where you can select another version and view the differences side-by-side:

![Lilypad Compare Versions](/assets/blog/_shared/lilypad-compare-versions-v2.webp)
...
![Lilypad Trace Data](/assets/blog/_shared/lilypad-trace-genai-data.webp)
...
![Lilypad Playground](/assets/blog/_shared/lilypad-playground-v3.webp)
