...
![Mirascope Cloud Answer Question v6 Trace](/assets/blog/langchain-sucks/lilypad-answer-question-v6-trace.webp)

Any changes to the code would increment this to V7.

![Mirascope Cloud Answer Question v7 Trace](/assets/blog/langchain-sucks/lilypad-answer-question-v7-trace.webp)

Mirascope Cloud automatically creates a nested trace whenever the function is executed:

![Mirascope Cloud OpenTelemetry GenAI Data](/assets/blog/langchain-sucks/lilypad-otel-genai-data.webp)
...
![Mirascope Cloud Answer Question Assign Annotation](/assets/blog/langchain-sucks/lilypad-answer-question-assign-annotation.webp)
...
![Mirascope Cloud Annotation Queue](/assets/blog/langchain-sucks/lilypad-annotation-queue.webp)
