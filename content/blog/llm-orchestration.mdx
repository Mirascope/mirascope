...
![IDE Documentation and Linting Example: Argument missing for parameter](/assets/blog/_shared/mirascope-type-hints.webp)

And providing auto suggestions:

![IDE Auto Suggestions: recommend_book_prompt](/assets/blog/_shared/mirascope-autocomplete.webp)
