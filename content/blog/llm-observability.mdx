...
![Lilypad Homepage](/assets/blog/_shared/lilypad-homepage.webp)
...
![Lilypad Answer Question Click Compare](/assets/blog/_shared/answer-question-click-compare.webp)

This shows a second dropdown menu, where you can select another version and view the differences side-by-side:

![Lilypad Answer Question Compare Versions](/assets/blog/_shared/lilypad-compare-versions.webp)
...
![Lilypad Answer Question Trace Data](/assets/blog/_shared/lilypad-trace-genai-data.webp)
...
![Lilypad Answer Question Annotations](/assets/blog/_shared/lilypad-annotations.webp)
