...
The goal isn’t just to watch but to _understand_. Observability helps you debug, test, and fine-tune prompts. You can tweak things in real time, compare versions, and use data to make better changes that actually improve results.
...
![Mirascope Cloud Homepage](/assets/blog/_lilypad/lilypad-homepage.webp)
...
But to trace the _why_ and _how_ (not just the _what_) we recommend wrapping your LLM calls in Python functions and decorating them with `@ops.version`. This captures the full execution context: inputs, model configuration, helper logic, and prompt transformations. Every run then becomes a reproducible, versioned snapshot of your code in action.
...
![Mirascope Cloud Answer Question v7 Trace](/assets/blog/_lilypad/lilypad-trace.webp)
...
![Mirascope Cloud Answer Question Click Compare](/assets/blog/_lilypad/answer-question-click-compare.webp)

This shows a second dropdown menu, where you can select another version and view the differences side-by-side:

![Mirascope Cloud Answer Question Compare Versions](/assets/blog/_lilypad/lilypad-compare-versions.webp)
...
![Mirascope Cloud Answer Question Trace Data](/assets/blog/_lilypad/lilypad-trace-genai-data.webp)
...
![Mirascope Cloud Playground](/assets/blog/_lilypad/lilypad-playground-v2-v2.webp)
...
![Mirascope Cloud Answer Question Annotations](/assets/blog/_lilypad/lilypad-annotations.webp)
...
![Phoenix Screenshot](/assets/blog/_shared/phoenix-screenshot.webp)
...
![Helicone Screenshot](/assets/blog/_shared/helicone-screenshot.webp)
...
![Lunary Screenshot](/assets/blog/_shared/lunary-screenshot.webp)
...
![Portkey Screenshot](/assets/blog/_shared/portkey-screenshot.webp)
