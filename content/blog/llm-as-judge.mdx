...
We define a [reusable, parameterized template](/blog/langchain-prompt-template/) for evaluating the helpfulness of a given text:
...
for model in models:
    ...
    def evaluate(text: str) -> str:
        return evaluate_helpfulness(text)
