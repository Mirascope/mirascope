...
<Callout title="Historical Content" type="info">
This post documents the Mirascope V1 release from August 2024. Code examples show V1 patterns which have since been superseded by V2. For current API patterns and documentation, see our [latest documentation](/docs/learn/llm).
</Callout>
...
Take a look at our [documentation](/docs/learn/llm) for a deeper dive that covers everything in detail.
...
1. Check out our [Quick Start Guide](/docs/learn/llm) to set up Mirascope in minutes.
2. Explore our [Documentation](/docs) for in-depth guides and examples.
3. Join our [Discord Community](https://mirascope.com/discord-invite) to discuss questions, stay up to date on announcements, or even show off what you've built.
