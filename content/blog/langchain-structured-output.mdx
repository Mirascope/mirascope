...
Setting `json_mode=True` in the call decorator will apply [JSON mode](/docs/learn/llm/json_mode/), if it's supported by your LLM, rendering the outputs as valid JSON:
...
@llm.call("openai/gpt-4o-mini", json_mode=True)  # [!code highlight]
...
print(json.loads(response.text()))  # [!code highlight]
