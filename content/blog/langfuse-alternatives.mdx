...
![Answer Question V1 Trace](/assets/blog/_shared/answer-question-v1-trace.webp)

Changing anything in the function or the prompt and then running the code again automatically produces version 2:

![Answer Question V2 Trace](/assets/blog/_shared/answer-question-v2-trace.webp)
...
![Answer Question Click Compare](/assets/blog/_shared/answer-question-click-compare.webp)

This toggles a second dropdown menu, where you can select another version and view the differences side-by-side.

![Answer Question Compare Versions](/assets/blog/_shared/lilypad-compare-versions.webp)
...
![Answer Question GenAI Data](/assets/blog/_shared/lilypad-genai-trace-data.webp)
