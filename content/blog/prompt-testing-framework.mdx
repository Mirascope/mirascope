...
![Mirascope Cloud GenAI Trace Data](/assets/blog/_lilypad/lilypad-otel-data-v3.webp)
...
![Mirascope Cloud Playground Trace](/assets/blog/_lilypad/lilypad-playground-trace-v2.webp)
...
![Mirascope Cloud Click Compare](/assets/blog/_lilypad/lilypad-click-compare-v2-v2.webp)

This toggles a second dropdown menu, where you can select another version and view the differences side-by-side. 

![Mirascope Cloud Compare Versions](/assets/blog/_lilypad/lilypad-compare-versions-v3.webp)
...
![LangSmith Dashboard](/assets/blog/_shared/langsmith_screenshot.webp)
