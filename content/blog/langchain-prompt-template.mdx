...
The model-agnostic [`llm.call` decorator](/docs/learn/llm) sends this structured message to the model and the return value is a response object that includes generated content, a full list of input messages, model parameters, usage metrics, and any tool or modality-specific metadata.
