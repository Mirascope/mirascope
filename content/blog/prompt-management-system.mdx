...
![Mirascope Cloud Homepage](/assets/blog/prompt-management-system/lilypad-homepage.webp)
...
![Mirascope Cloud Trace Data](/assets/blog/prompt-management-system/lilypad-trace-data.webp)

You can also compare metadata and output differences between different versions of code by clicking the "Compare" button:

![Mirascope Cloud Click Compare](/assets/blog/prompt-management-system/lilypad-click-compare.webp)

Clicking this displays a second dropdown menu, where you can select another version and view the differences side-by-side.

![Mirascope Cloud Compare Versions](/assets/blog/prompt-management-system/lilypad-compare-versions.webp)
...
![Mirascope Cloud Playground](/assets/blog/prompt-management-system/lilypad-playground.webp)
...
![Mirascope Cloud Annotation Queue](/assets/blog/prompt-management-system/lilypad-annotation-queue.webp)
...
client.annotations.create(
    project_uuid=os.environ["MIRASCOPE_PROJECT_ID"],
    body=[
        {
            "span_uuid": "...",
            "project_uuid": os.environ["MIRASCOPE_PROJECT_ID"],
...
Using `mode="wrap"` in the `@ops.trace` decorator converts the function's return value into a `Traced[R]` object, which makes it easy to log feedback directly in code.
...
@ops.trace(name="Answer Question", mode="wrap")
@llm.call("google/gemini-2.0-flash")
def answer_question(question: str) -> str:
    return f"Answer this question: {question}"

trace: ops.Trace[str] = answer_question("What is the capital of France?")
...
![Agenta Screenshot](/assets/blog/prompt-management-system/agenta-screenshot.webp)
...
![PromptHub Homepage](/assets/blog/prompt-management-system/prompthub-homepage.webp)
...
![Langfuse Homepage](/assets/blog/prompt-management-system/langfuse-homepage.webp)
