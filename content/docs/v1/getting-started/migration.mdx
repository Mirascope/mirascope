---
title: Migration Guide: v0 → v1
description: Learn how to upgrade from Mirascope v0 to v1 with our comprehensive migration guide.
---

# Mirascope 0.x Migration Guide

<Warning title="This Guide May Not Cover Everything">
...
Remember to update your import statements to use `from mirascope.core import ...` instead of the provider-specific imports used in v0.

If you encounter any issues during migration or have questions about the new features, please reach out to the Mirascope community for support.