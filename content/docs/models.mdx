...
| `thinking` | `ThinkingConfig` | Configuration for extended reasoning. See [Thinking](/docs/thinking). |
...
- [Responses](/docs/responses) — Working with LLM responses
- [Streaming](/docs/streaming) — Streaming response content
- [Tools](/docs/tools) — Enabling LLMs to call functions
