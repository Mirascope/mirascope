...
<Info>
MCP tools are always async. You'll want to read the [Tools](/docs/llm/tools) and [Async](/docs/llm/async) guides first.
</Info>
...
<TabbedSection>
<Tab value="Call">
<CodeExample file="python/examples/mcp/basic_call.py" />
</Tab>
<Tab value="Prompt">
<CodeExample file="python/examples/mcp/basic_prompt.py" />
</Tab>
<Tab value="Model">
<CodeExample file="python/examples/mcp/basic_model.py" />
</Tab>
</TabbedSection>
...
<CodeExample file="python/examples/mcp/combined_tools.py" />

## Next Steps

- [Tools](/docs/llm/tools) — Tool calling fundamentals
- [Async](/docs/llm/async) — Async patterns
- [Agents](/docs/llm/agents) — Build agents with MCP tools
