...
<Note>
When validation fails, consider retrying with error feedback. See [Reliability](/docs/llm/reliability) for retry patterns.
</Note>
...
- [Streaming](/docs/llm/streaming) — Stream responses with structured output
- [Reliability](/docs/llm/reliability) — Retry on validation errors
- [Tools](/docs/llm/tools) — Combine tools with structured output
