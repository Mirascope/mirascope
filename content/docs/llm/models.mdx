...
<CodeExample file="python/examples/models/call_patterns.py" />
...
<CodeExample file="python/examples/models/override.py" />
...
<CodeExample file="python/examples/models/with_params.py" />
...
| `thinking` | `ThinkingConfig` | Configuration for extended reasoning. See [Thinking](/docs/llm/thinking). |
...
- [Responses](/docs/llm/responses) — Working with LLM responses
- [Streaming](/docs/llm/streaming) — Streaming response content
- [Tools](/docs/llm/tools) — Enabling LLMs to call functions
