...
When a session nears the end of its context window, the system triggers a **memory flush** — a silent turn that reminds the claw to save any durable memories before context is compacted.
