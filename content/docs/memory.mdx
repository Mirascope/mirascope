...
Periodically (during [heartbeat](/docs/heartbeats) cycles), the claw reviews recent daily files and updates `MEMORY.md` with lasting insights. This is like a human reviewing their journal and distilling what matters:
