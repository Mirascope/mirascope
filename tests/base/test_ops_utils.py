...
def test_handle_call(
    ...
    test_model.call()
    test_model.handle_before_call.assert_called_once()
...
@pytest.mark.asyncio
async def test_handle_call_async(
    mock_create,
    fixture_chat_completion: ChatCompletion,
    fixture_with_saving,
    fixture_with_saving_without_async,
):
    ...
    test_model_no_async.handle_after_call.assert_called_once()
