...
from mirascope.core.azureai._utils._get_credential import (
...
def test_get_credential(key_value, expected_type):
    with patch(
        "mirascope.core.azureai._utils._get_credential._get_key_from_env",
        return_value=key_value,
    ):
        if key_value is None:
            with patch(
                "mirascope.core.azureai._utils._get_credential._get_azure_default_credential"
