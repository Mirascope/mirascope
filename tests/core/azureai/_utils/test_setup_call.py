"""Tests the `azureai._utils.setup_call` module."""
...
from mirascope.core.azureai._utils._setup_call import setup_call
...
@patch(
    "mirascope.core.azureai._utils._setup_call.ChatCompletionsClient",
    new_callable=MagicMock,
)
@patch(
    "mirascope.core.azureai._utils._setup_call.convert_message_params",
    new_callable=MagicMock,
)
@patch("mirascope.core.azureai._utils._setup_call._utils", new_callable=MagicMock)
def test_setup_call(
    mock_utils: MagicMock,
    mock_convert_message_params: MagicMock,
    mock_azureai: MagicMock,
    ...
    mock_base_setup_call.assert_called_once_with(fn, {}, None, None, AzureAITool, {})
    mock_convert_message_params.assert_called_once_with(
        mock_base_setup_call.return_value[1]
    )
    assert messages == mock_convert_message_params.return_value
    mock_create = mock_azureai.return_value.complete
