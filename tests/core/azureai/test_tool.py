...
from mirascope.core.azureai.tool import AzureAITool, AzureAIToolConfig

#
from mirascope.core.base.tool import BaseTool


def test_azureai_tool() -> None:
    """Tests the `AzureAITool` class."""
    ...
    assert isinstance(tool, AzureAITool)
...
def test_azureai_tool_strict() -> None:
    """Tests the strict settings for the `AzureAITool` class."""
    ...
    class FormatBook(AzureAITool):
        ...
        tool_config = AzureAIToolConfig(strict=True)
