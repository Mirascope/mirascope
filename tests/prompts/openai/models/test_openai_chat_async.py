...
from mirascope.prompts.openai.models import AsyncOpenAIChat
...
@patch(
    "mirascope.prompts.openai.models.AsyncOpenAIChat.create",
    new_callable=AsyncMock,
)
...
async def test_openai_chat_extract_no_deprecation_warning(
    ...
    chat = AsyncOpenAIChat(api_key="test")
    await chat.extract(MySchema, fixture_foobar_prompt)
