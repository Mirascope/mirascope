...
@pytest.fixture
def computer_toolkit() -> DockerOperationToolKit:
...
def test_execute_python(computer_toolkit: DockerOperationToolKit):
...
def test_execute_python_with_requirements(computer_toolkit: DockerOperationToolKit):
...
"""
    ...
    tool, _ = DockerOperationToolKit(config=config).create_tools()
    assert issubclass(tool, DockerOperationToolKit.ExecutePython)
...
def test_execute_shell(computer_toolkit: DockerOperationToolKit):
...
def test_container_cleanup(computer_toolkit: DockerOperationToolKit):
...
def test_execute_python_with_syntax_error(computer_toolkit: DockerOperationToolKit):
...
def test_execute_shell_with_error(computer_toolkit: DockerOperationToolKit):
...
def test_container_error_handling(computer_toolkit: DockerOperationToolKit):
...
def test_execute_python_with_file_creation(computer_toolkit: DockerOperationToolKit):
...
def test_execute_shell_with_pipe(computer_toolkit: DockerOperationToolKit):
...
def test_container_cleanup_on_error():
    ...
    toolkit = DockerOperationToolKit(config=config)
...
def test_docker_operation_del(computer_toolkit: DockerOperationToolKit):
...
def test_usage_description(computer_toolkit: DockerOperationToolKit):
