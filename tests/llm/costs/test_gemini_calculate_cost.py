...
from mirascope.llm.costs._gemini_calculate_cost import calculate_cost
...
def test_calculate_cost() -> None:
    ...
    assert calculate_cost(CostMetadata(input_tokens=1, output_tokens=1), model="gemini-1.5-flash") == 0.000000375
