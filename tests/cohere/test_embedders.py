...
@pytest.mark.parametrize(
    "cohere_embeddings,instance",
    [
        ("fixture_cohere_embeddings", list),
        ("fixture_cohere_embeddings_by_type_float", list),
        ("fixture_cohere_embeddings_by_type_int8", list),
        ("fixture_cohere_embeddings_by_type_uint8", list),
        ("fixture_cohere_embeddings_by_type_binary", list),
        ("fixture_cohere_embeddings_by_type_ubinary", list),
        ("fixture_cohere_embeddings_by_type_no_data", type(None)),
    ],
)
