...
text_msg = llm.messages.user("Hello, how are you?")
...
image_msg = llm.messages.user(["What book is shown in this image?", image])
...
audio_msg = llm.messages.user(audio)
...
video_msg = llm.messages.user(["What do you think of this book review?", video])

document = llm.Document(
    data="/path/to/research-paper.pdf",  # or URL, base64, or bytes
    mime_type="application/pdf",
)
document_msg = llm.messages.user(["Please summarize this research paper:", document])
...
tool_call_msg = llm.messages.assistant([tool_call])

tool_output = llm.ToolOutput(
    id="call_weather_123",
    value={"temperature": 72, "condition": "sunny", "humidity": 45},
)
tool_output_msg = llm.messages.user([tool_output])
...
thinking_msg = llm.messages.assistant(
    [
        thinking,
