...
<Tab value="Typescript">
<CodeExample file="typescript/examples/messages/conversations.ts" lines="13-24" />
</Tab>
</TabbedSection>
...
<Tab value="Typescript">
<CodeExample file="typescript/examples/messages/conversations.ts" lines="3-5" />
</Tab>
</TabbedSection>
...
<Tab value="Typescript">
<CodeExample file="typescript/examples/messages/conversations.ts" lines="5-11" />
</Tab>
</TabbedSection>
...
In the next section on [Prompt Templates](./prompt-templates), we will describe how Mirascope provides a reusable functional interface for constructing messages. This offers a maintainable way to construct and optimize messages, which will then be used for llm [Calls](./calls).
