...
<CodeExample file="examples/providers/custom_api_key.py" />
...
<CodeExample file="examples/providers/openai_compatible.py" />
...
<CodeExample file="examples/providers/scope_matching.py" />
...
- [Models](/docs/mirascope/v2/models) — Working with models directly
- [Errors](/docs/mirascope/v2/errors) — Unified error handling across providers
- [Local Models](/docs/mirascope/v2/local-models) — Using Ollama, MLX, and other local models
