...
<TabbedSection>
<Tab value="@llm.call">
<CodeExample file="examples/chaining/basic_call.py" />
</Tab>
<Tab value="@llm.prompt">
<CodeExample file="examples/chaining/basic_prompt.py" />
</Tab>
<Tab value="Model">
<CodeExample file="examples/chaining/basic_model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="@llm.call">
<CodeExample file="examples/chaining/nested_call.py" />
</Tab>
<Tab value="@llm.prompt">
<CodeExample file="examples/chaining/nested_prompt.py" />
</Tab>
<Tab value="Model">
<CodeExample file="examples/chaining/nested_model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="@llm.call">
<CodeExample file="examples/chaining/conditional_call.py" />
</Tab>
<Tab value="@llm.prompt">
<CodeExample file="examples/chaining/conditional_prompt.py" />
</Tab>
<Tab value="Model">
<CodeExample file="examples/chaining/conditional_model.py" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="@llm.call">
<CodeExample file="examples/chaining/parallel_call.py" />
</Tab>
<Tab value="@llm.prompt">
<CodeExample file="examples/chaining/parallel_prompt.py" />
</Tab>
<Tab value="Model">
<CodeExample file="examples/chaining/parallel_model.py" />
</Tab>
</TabbedSection>
...
<Note>
Parallel chains require async functions. See [Async](/docs/mirascope/v2/async) for more on async patterns.
</Note>
...
- [Structured Output](/docs/mirascope/v2/structured-output) — Parse responses into typed objects
- [Async](/docs/mirascope/v2/async) — Concurrent execution patterns
- [Agents](/docs/mirascope/v2/agents) — Autonomous systems that chain tools and calls
