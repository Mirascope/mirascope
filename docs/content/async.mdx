...
<TabbedSection>
<Tab value="@llm.call">
<CodeExample file="examples/async/basic.py" />
</Tab>
<Tab value="@llm.prompt">
<CodeExample file="examples/async/basic_prompt.py" />
</Tab>
<Tab value="Model">
<CodeExample file="examples/async/basic_model.py" />
</Tab>
</TabbedSection>
...
<CodeExample file="examples/async/parallel.py" />
...
<CodeExample file="examples/async/async_tools.py" />
...
Tools from [MCP](/docs/mirascope/v2/mcp) servers are always async, so you'll need to use async when working with MCP.
</Note>
...
<CodeExample file="examples/async/async_streaming.py" />
...
- Interacting with [MCP](/docs/mirascope/v2/mcp) servers
...
- [Agents](/docs/mirascope/v2/agents) — Build agents with async patterns
