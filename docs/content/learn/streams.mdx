...
Either way, you will get an `llm.AsyncStream` that supports async iteration. If your prompt is synchronous, then we recommend using `stream_async` for call-time flexibility.
