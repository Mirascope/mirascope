...
<TabbedSection>
<Tab value="Python">
<CodeExample file="examples/prompt_templates/multimodal.py" lines="16-17" />
</Tab>
<Tab value="Typescript">
<CodeExample file="typescript/examples/prompt-templates/multimodal.ts" lines="21-25" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Python">
<CodeExample file="examples/prompt_templates/multimodal.py" lines="28-29" />
</Tab>
<Tab value="Typescript">
...
<TabbedSection>
<Tab value="Python">
<CodeExample file="examples/prompt_templates/multimodal.py" lines="32-33" />
</Tab>
<Tab value="Typescript">
<CodeExample file="typescript/examples/prompt-templates/multimodal.ts" lines="45-49" />
</Tab>
</TabbedSection>
...
<TabbedSection>
<Tab value="Python">
<CodeExample file="examples/prompt_templates/multimodal.py" lines="36-49" />
</Tab>
<Tab value="Typescript">
