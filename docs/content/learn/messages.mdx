...
LLMs operate on sequences of messages, which provide the context that the LLM responds to. A sequence of messages is called a "prompt". Here, we show how some common prompting patterns can be constructed using the Mirascope message APIs.
...
<TabbedSection>
<Tab value="Python">
<CodeExample file="examples/messages/prompts.py" lines="15-24" />
</Tab>
<Tab value="Typescript">
