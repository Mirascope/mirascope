...
<TabbedSection>
<Tab value="@llm.call">
<CodeExample file="examples/context/basic_call.py" />
</Tab>
<Tab value="@llm.prompt">
<CodeExample file="examples/context/basic_prompt.py" />
</Tab>
<Tab value="Model">
<CodeExample file="examples/context/basic_model.py" />
</Tab>
</TabbedSection>
...
<CodeExample file="examples/context/async_context.py" />
