...
<CodeExample file="examples/calls/basic.py" />
...
<CodeExample file="examples/calls/with_params.py" />
...
<CodeExample file="examples/calls/access_prompt.py" />
