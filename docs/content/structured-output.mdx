...
<CodeExample file="examples/structured_output/primitives.py" />
...
<CodeExample file="examples/structured_output/basemodel.py" />
...
<CodeExample file="examples/structured_output/generic_collection.py" />
...
<Note>
When validation fails, consider retrying with error feedback. See [Reliability](/docs/mirascope/v2/reliability) for retry patterns.
</Note>
...
<CodeExample file="examples/structured_output/explicit_mode.py" />
...
<CodeExample file="examples/structured_output/with_tools.py" />
...
<CodeExample file="examples/structured_output/advanced_model_features.py" />
...
<CodeExample file="examples/structured_output/custom_instructions.py" />
...
<CodeExample file="examples/structured_output/output_parser.py" />
...
- [Streaming](/docs/mirascope/v2/streaming) — Stream responses with structured output
- [Reliability](/docs/mirascope/v2/reliability) — Retry on validation errors
- [Tools](/docs/mirascope/v2/tools) — Combine tools with structured output
