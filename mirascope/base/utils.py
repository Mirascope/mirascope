...
def convert_function_to_chunker(
    fn: Callable, base: Type[BaseChunkerT]
) -> Type[BaseChunkerT]:
    """Constructs a `BaseChunkerT` type from the given function.
    ...
    Returns:
        The constructed `BaseChunkerT` type.
    ...
    field_definitions["chunk_fn"] = (Callable[[str], list[Document]], fn)
